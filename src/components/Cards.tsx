  ...
  return (
    <div className="flex justify-center flex-wrap mt-5   gap-10">
      <div className="flex flex-col gap-5 px-3 py-4 text-gray-700 shadow-xl rounded-xl  max-w-80 max-h-[227px] bg-white dark:bg-[#262626] dark:border dark:border-gray-700 w-full">
        ...
        <div className="w-full text-base dark:text-white  font-normal">
      ...
      <div className="flex flex-col gap-5 px-3 py-4 text-gray-700 shadow-xl rounded-xl  max-w-80 max-h-[227px] bg-white dark:bg-[#262626] border dark:border dark:border-gray-700 w-full">
        ...
        <div className="w-full text-base  font-normal dark:text-white ">
          Get a standout X (Twitter) bio that's all you, all unique in seconds
        </div>
        <div className="flex items-start justify-center  pt-0 gap-5">
          <button className="dark:bg-white dark:text-gray-900 flex w-full p-1 md:p-2 justify-center my-auto gap-2.26 rounded-full bg-gray-900  text-white font-outfit text-base font-medium px-10 mx-auto">
      ...
      <div className="flex flex-col gap-5 px-3 py-4 text-gray-700 shadow-xl rounded-xl  max-w-80 max-h-[227px] bg-white dark:bg-[#262626] border dark:border dark:border-gray-700 w-full">
        <div className="flex flex-row gap-8  justify-center items-center ">
          ...
          >
            <path
              d="M45.2427 30.0842C44.8039 21.9944 40.3839 17.3631 32.9631 17.3171C28.4889 17.29 24.7487 19.1858 22.4575 22.6606L26.5417 25.4583C28.2587 22.8556 30.9698 22.3167 32.9333 22.3356C35.3789 22.3519 37.2206 23.0615 38.415 24.4481C39.2816 25.4556 39.8639 26.8504 40.1537 28.6081C37.9871 28.2398 35.6416 28.126 33.1392 28.2696C26.0812 28.6758 21.5475 32.7925 21.8508 38.5098C22.0052 41.4104 23.4487 43.9075 25.9187 45.5379C28.0041 46.9165 30.6962 47.5881 33.4885 47.4365C37.18 47.2333 40.0752 45.8277 42.0956 43.2521C43.6285 41.2967 44.5981 38.7617 45.026 35.5712C46.7864 36.6329 48.0864 38.0277 48.8096 39.7069C50.0337 42.5615 50.1041 47.2523 46.2773 51.0765C42.9244 54.424 38.8944 55.8756 32.8033 55.919C26.046 55.8702 20.9354 53.7008 17.615 49.4785C14.5004 45.5244 12.8944 39.8098 12.8348 32.5C12.8944 25.1875 14.5031 19.4756 17.615 15.5188C20.9354 11.2965 26.046 9.12979 32.8033 9.08104C39.6094 9.1325 44.8067 11.3073 48.2571 15.554C49.9498 17.634 51.2227 20.2502 52.065 23.2998L56.8479 22.0269C55.8269 18.2704 54.2235 15.034 52.0433 12.35C47.6206 6.90625 41.1206 4.11937 32.7871 4.0625C24.4698 4.11937 18.0754 6.91979 13.7773 12.3798C9.95582 17.2413 7.98144 24.0419 7.91644 32.519C7.98144 40.996 9.95582 47.7588 13.7773 52.6202C18.0754 58.0802 24.5023 60.8806 32.8169 60.9375C40.2133 60.886 45.4241 58.9496 49.7169 54.6623C55.3367 49.0479 55.166 42.0144 53.3162 37.6973C51.8944 34.3796 49.0641 31.7227 45.2454 30.0869M33.2258 42.4287C30.1329 42.6021 26.9208 41.2154 26.761 38.2417C26.6446 36.0371 28.3319 33.5779 33.4154 33.2854C35.7129 33.1312 38.0208 33.2897 40.2756 33.7567C39.6906 41.0746 36.2537 42.2608 33.2258 42.4287Z"
              fill="black"
            />
          </svg>

          <div className=" flex items-center text-xl text-black dark:text-white font-outfit  font-semibold">
            AI Threads Bio Generator{" "}
          </div>
        </div>
        <div className="w-full text-base  font-normal dark:text-white ">
          Get a standout X (Twitter) bio that's all you, all unique in seconds
