const Cards = () => {
  ...
  <g clip-path="url(#clip0_0_83)">
    <path d="M52.4 26.5C52.4 12.0855 40.7145 0.399994 26.3 0.399994C11.8854 0.399994 0.199951 12.0855 0.199951 26.5C0.199951 39.5272 9.7444 50.325 22.2218 52.2829V34.0445H15.5949V26.5H22.2218V20.7498C22.2218 14.2085 26.1185 10.5953 32.0803 10.5953C34.9358 10.5953 37.9226 11.1051 37.9226 11.1051V17.5281H34.6316C31.3892 17.5281 30.3781 19.5401 30.3781 21.6042V26.5H37.6167L36.4596 34.0445H30.3781V52.2829C42.8555 50.325 52.4 39.5274 52.4 26.5Z" fill="#1877F2"/>
    <path d="M36.4596 34.0446L37.6168 26.5H30.3781V21.6042C30.3781 19.5399 31.3893 17.5281 34.6316 17.5281H37.9226V11.1051C37.9226 11.1051 34.9358 10.5953 32.0801 10.5953C26.1185 10.5953 22.2218 14.2086 22.2218 20.7499V26.5H15.5949V34.0446H22.2218V52.283C23.5709 52.4944 24.9344 52.6004 26.3 52.6C27.6655 52.6004 29.029 52.4944 30.3781 52.283V34.0446H36.4596Z" fill="white"/>
  </g>
  <defs>
    <clipPath id="clip0_0_83">
      <rect width="52.2" height="52.2" fill="white" transform="translate(0.199951 0.399994)"/>
    </clipPath>
  </defs>
</svg>

          <div className=" flex items-center text-xl text-black font-Outfit  font-semibold">
          AI Facebook Bio Generator          </div>
        </div>
        <div className="w-full text-base  font-normal">
          Get a standout X (Twitter) bio that's all you, all unique in seconds
        </div>
