        ...
        <div className="flex justify-center  gap-10">
            ...
            <div className="relative flex flex-col mt-6 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-96">
                <div className="flex flex-row justify-center p-6">
                    <div className="inline-flex p-11.03 items-center gap-11.03 rounded-5.515">
                        <div className="w-36.697 h-37.503"><svg xmlns="http://www.w3.org/2000/svg" width="37" height="38" viewBox="0 0 37 38" fill="none">
  <path d="M22.1409 16.3738L35.8019 0.493652H32.5643L20.7029 14.2818L11.2287 0.493652H0.301323L14.628 21.3441L0.301323 37.9965H3.53887L16.0654 23.4357L26.0705 37.9965H36.9979L22.14 16.3738H22.1409ZM17.7068 21.5275L16.255 19.4514L4.70527 2.93075H9.67792L18.9983 16.2636L20.4497 18.3397L32.5658 35.6702H27.5937L17.7068 21.5284V21.5275Z" fill="black"/>
</svg>
                        </div>
                        </div>
                    <div className=" flex items-center w-170.847 p-4 text-black font-Outfit text-base font-medium">AI X(Twitter) Bio Generator</div>
                </div>
            <div className="p-4">
            ...
            <div className="flex items-start justify-center  p-6 pt-0 gap-5">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="23" height="24" viewBox="0 0 23 24" fill="none" className="w-6 h-6 text-gray-700 dark:text-gray-300">
  <path fill-rule="evenodd" clip-rule="evenodd" d="M3.77765 5.56119C3.77765 4.81199 4.07527 4.09347 4.60503 3.56371C5.13479 3.03395 5.85331 2.73633 6.60251 2.73633H16.0187C16.7679 2.73633 17.4864 3.03395 18.0162 3.56371C18.5459 4.09347 18.8436 4.81199 18.8436 5.56119V20.6535C18.8436 21.8022 17.5441 22.4708 16.61 21.8032L11.3106 18.0179L6.01117 21.8032C5.07614 22.4717 3.77765 21.8032 3.77765 20.6544V5.56119ZM6.60251 4.61957C6.35277 4.61957 6.11327 4.71877 5.93668 4.89536C5.76009 5.07195 5.66089 5.31145 5.66089 5.56119V19.7392L10.4895 16.29C10.7291 16.1188 11.0162 16.0268 11.3106 16.0268C11.605 16.0268 11.8921 16.1188 12.1317 16.29L16.9603 19.7392V5.56119C16.9603 5.31145 16.8611 5.07195 16.6845 4.89536C16.5079 4.71877 16.2684 4.61957 16.0187 4.61957H6.60251Z" fill="#1E1E1E"/>
</svg>
        ...
        <div className="relative flex flex-col mt-6 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-96">
            <div className="flex flex-row justify-center p-3">
                 <div className="inline-flex p-4 items-center gap-2.756 rounded-md"><span className="w-52.2 h-52.2 flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="53" height="53" viewBox="0 0 53 53" fill="none">
  <g clip-path="url(#clip0_86_231)">
    <path d="M52.4 26.4999C52.4 12.0854 40.7145 0.399902 26.3 0.399902C11.8854 0.399902 0.199951 12.0854 0.199951 26.4999C0.199951 39.5271 9.7444 50.3249 22.2218 52.2828V34.0444H15.5949V26.4999H22.2218V20.7497C22.2218 14.2084 26.1185 10.5952 32.0803 10.5952C34.9358 10.5952 37.9226 11.105 37.9226 11.105V17.528H34.6316C31.3892 17.528 30.3781 19.54 30.3781 21.6041V26.4999H37.6167L36.4596 34.0444H30.3781V52.2828C42.8555 50.3249 52.4 39.5273 52.4 26.4999Z" fill="#1877F2"/>
    <path d="M36.4596 34.0444L37.6168 26.4999H30.3781V21.6041C30.3781 19.5398 31.3893 17.528 34.6316 17.528H37.9226V11.105C37.9226 11.105 34.9358 10.5952 32.0801 10.5952C26.1185 10.5952 22.2218 14.2084 22.2218 20.7497V26.4999H15.5949V34.0444H22.2218V52.2828C23.5709 52.4943 24.9344 52.6003 26.3 52.5999C27.6655 52.6003 29.029 52.4943 30.3781 52.2828V34.0444H36.4596Z" fill="white"/>
  </g>
  <defs>
    <clipPath id="clip0_86_231">
      <rect width="52.2" height="52.2" fill="white" transform="translate(0.199951 0.399902)"/>
    </clipPath>
  </defs>
</svg>
                    </span></div>
                 <div className="flex items-center w-170.847 p-4 text-black font-Outfit text-base font-medium">AI Facebook Bio Generator</div>   
            </div>
            <div className="p-4">
                <p className="w-268.475 px-6 h-30.734 flex-shrink-0 text-black font-Outfit text-sm font-normal">
                Upgrade your Facebook bio with AI's creative touch for a standout profile! </p>
            </div>  
            <div className="flex items-start justify-center  p-6 pt-0 gap-5">
            <button className="flex w-full p-2.26 md:p-9.04 justify-center  gap-2.26 rounded-full bg-gray-900 p-1 text-white font-Outfit text-base font-medium mx-auto px-10">Generate
            </button>
            <button className="flex w-40.678 h-38.87 p-2.26  gap-2.26 rounded-full border-2 border-gray-800 p-1 justify-end">
                <span className="w-22.599 h-22.599 flex-shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" width="23" height="24" viewBox="0 0 23 24" fill="none" className="w-6 h-6 text-gray-700 dark:text-gray-300">
